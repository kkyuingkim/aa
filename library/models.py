...
class Library(models.Model):
    ...
    category = models.CharField(max_length=10,  default='News', choices=[('마케팅자료', '마케팅자료')], verbose_name='카테고리')
    ...
    image0 = ProcessedImageField(null=True, blank=True, upload_to='data/', processors = [ResizeToFill(THUMB_WIDTH, THUMB_HEIGHT)], format = 'JPEG', options = {'quality': 90}, default="", verbose_name='커버 이미지')
    file0 = models.FileField(null=True, blank=True, upload_to='data/', verbose_name='파일')
