...
# conn = pyodbc.connect('DRIVER=django.db.backends.mysql; SERVER=chagaun.net; DATABASE=chagaun; UID=chagaun_user; PWD=chagaun4!!')
conn = pyodbc.connect("DRIVER={ODBC Driver 17 for SQL Server};SERVER='chagaun.net';DATABASE='chagaun';UID='chagaun_user';PWD='chagaun4!!'")
